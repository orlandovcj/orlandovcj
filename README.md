# Olá, eu sou Orlando Castro 👋

💼 Auditor Governamental e Desenvolvedor de Sistemas

Tenho interesse em transformar dados em informações úteis e desenvolver soluções que integrem software, hardware e análise de dados.
...
- 🐍 Desenvolvimento com Python e SQL
...
Python • SQL • Dash • Streamlit • Plotly • HTML • CSS • JavaScript • Arduino • ESP32 • LoRa • Raspberry Pi • Git

## 📌 Projetos

- Dashboards interativos para análise de dados
  
- Ferramentas para auditoria e gestão pública
  
- Aplicações IoT com ESP32, Arduino e Raspberry Pi
